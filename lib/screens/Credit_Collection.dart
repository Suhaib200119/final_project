...
import '../widgets/Card_Collection_Reading_Screen.dart';

class Credit_Collection extends StatelessWidget {
                      ...
                      if(snapshot.connectionState==ConnectionState.waiting){
                        ...
                        List<DocumentSnapshot> list_docs = (snapshot.data! as QuerySnapshot).docs.where((element){
                          return element.get("name_employee").toString()==Provider.of<MyProvider>(context).dropdown_value_name&&
                              element.get("name_region").toString()==Provider.of<MyProvider>(context).dropdown_value_region&&element.get("balance")>0;
                        }).toList();
                        return ListView.separated(
                            ...
                            itemBuilder: (context,index){
                              return Card_Collection_Reading(list_docs[index],index,"C");
                            },
